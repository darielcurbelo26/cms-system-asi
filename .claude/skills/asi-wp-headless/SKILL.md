...
- [ ] Probar la integración real del frontend (`cms-engine.js`) contra este endpoint real, sirviendo el sitio con un servidor estático y observando los 3 escenarios de la sección "Verificación".
